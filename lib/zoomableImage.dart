// MOST OF THIS CODE IS NOT FROM US. Most of it was taken from the open source zoomable-image library
// found at https://pub.dev/packages/zoomable_image/ . The version that is accessible through the
// Dart package manager does not compile due to some simple errors, so I have taken the liberty of
// fixing them.
...
class _ZoomableImageState extends State<ZoomableImage> {
  ...
  double _startingScale;  // Everything with this variable is done by Team Teal to prevent excessive
                          // zooming out
  ...
  void _resolveImage() {
    ...
    // Begin code added by Team Teal
    if (_listener == null)
    {
      _listener = ImageStreamListener(_handleImageLoaded);
    }
    _imageStream.addListener(_listener);
    // End code written by Team Teal
  }
  ...
  @override
  void dispose() {
    // Begin code written by Team Teal

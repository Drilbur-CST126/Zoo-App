...
INSERT INTO animal.animals (animal_id, common_name, scientific_name, qr_code, tags, class_id, exhibit_id)
VALUES (9, 'Allen''s Swmap Monkey', 'Allenopithecus Nigroviridis', 0, '', 1, 1);
INSERT INTO animal.animals (animal_id, common_name, scientific_name, qr_code, tags, class_id, exhibit_id)
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (28, 'The scientific name for the African painted dog is Lycaon pictus, which means 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (29, 'The red-bill lives in open savanna, woodland and thorn scrub in sub-Saharan Africa. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (30, 'Pythons are the largest species of snake in Africa. They live in grasslands 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (31, 'Slender-nosed crocodiles grow up to 13 feet long and weigh up to 500 pounds. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (32, 'The African spurred tortoise lives in semi-arid grasslands, scrub and 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (33, 'Swamp monkeys forage on the ground and in shallow water. They eat fruit, leaves and 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (34, 'The beaver''s body is wonderfully adapted for swimming in cold water. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (35, 'Black bears are opportunistic omnivores—that is, they will eat whatever is available, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (36, 'Like human fingerprints, the striped pattern on each Amur tiger''s fur is unique 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (37, 'As highly intelligent and social animals, Asian elephants communicate with each 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (38, 'They live in and eat the leaves of eucalyptus trees.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (39, 'Black-and-white ruffed lemurs are active in the morning and late afternoon. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (40, 'Black rhinos use their keen sense of hearing and smell to detect predators. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (41, 'Their diet consists primarily of fruits, vegetable matter, seeds, nuts, leaves and bark. They also eat clay on exposed riverbank clay licks as a mineral supplement.
Blue and gold macaws are generally seen in pairs but may form flocks of up to 30 birds. 
Paired birds fly with wings almost touching. Each morning, they fly from roosting sites to feeding grounds and return just before sunset, flying high above the forest canopy. They do not migrate.
These macaws are extremely wary. At the slightest sign of danger, they rise into the air, screeching loudly.
Their powerful beak crushes seeds and opens nuts. For very hard nuts, the bird uses the lower part of the beak to file down the nut''s shell before cracking it open. 
The thick, fleshy tongue moves the food around as the macaw works on it.', 17);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (42, 'Bobcats are generally solitary, coming together during mating season or when a female is with her kittens.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (43, 'These handsome animals spend their day feeding on short grass, but they are less 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (44, 'The bufflehead''s name is a combination of buffalo and head, due to the bulbous shape of the male''s head when he puffs up the white feathers on the back of his head.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (45, 'Like wild cats, domestic cats can see clearly at one-sixth the light level we would need. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (46, 'Named for its large head, the bull trout is a species of char native to Northwestern North America.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (47, ' Historical and scientific evidence suggests they once bred in the Pacific Northwest, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (48, 'Cattle egrets follow large grazers such as buffalo and elephants.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (49, 'The cheetah''s body is uniquely designed for speed. Its lightweight, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (50, 'Chimpanzees are highly intelligent and have rich social lives. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (51, 'Wild Chinook salmon are found all along the west coast of North America, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (52, 'Groups of cinnamon teal often swim behind each other, taking advantage of the food stirred up by the bird in front.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (54, 'Coho salmon are anadromous fish: they are born in freshwater, migrate to the sea 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (55, 'Colobus monkeys live mostly in the trees and eat leaves and fruit. To help them digest all that foliage, they have a multi-chambered stomach and gut microbes that break down cellulose. They get water from dew and the moisture in their food, or from rainwater in tree hollows.
Colobus monkeys are unusual for their beautiful black and white coloring. They are 18 to 27 inches long, not counting their tails, and weigh between 12 and 32 pounds. Males are usually slightly bigger than females. With only four fingers and no thumb, they move quickly through the trees.', 30);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (56, 'Adults eat ground-dwelling insects and small animals; young eat fruit flies and small crickets.
Their venom is mild.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (57, 'Cougars usually hunt at dawn and dusk. A hunting cougar will quietly stalk its prey, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (58, 'De Brazza''s monkeys forage in the early morning and evening; they hand-gather fruit, buds, young leaves, flowers and catch lizards.
...
These monkeys are territorial and live in small groups. Daughters may stay with mothers their entire lives. Males leave when they are sexually mature.', 33);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (59, 'Desert tortoises forage for leaves, stems, flowers, seeds and grasses.
...
Turtles and their eggs have many predators including Gila monsters, snakes, ravens, foxes, bobcats, coyotes, domestic dogs and more.', 34);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (60, 'This squirrel-sized mongoose is the smallest of the African mongooses. It is short and stocky, with a blunt, pointed muzzle and long tail. It is usually a speckled-brown or reddish color.
...
Dwarf mongooses and ground hornbills have a symbiotic relationship (one that benefits both animals). They often feed together; as the mongooses disturb insects with their muzzles, hornbills pounce on the food; hornbills make loud calls to alert mongooses of approaching predators.', 35);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (53, 'Length and defense: 3 to 4 feet, the smallest of African pythons; defense against larger predators is to coil in a tight ball.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (107, 'The giant African millipede is the largest of the world''s 10,000 species of millipedes.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (108, 'The giraffe is the tallest land-based mammal in the world. Males stand up to 18 feet 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (109, 'Golden eagles are found in Europe, Asia, North Africa, the Arabian Peninsula and 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (110, 'Grey gulls run back and forth between receding waves of western South American beaches, searching for small crustaceans in the sand. They also sometimes scavenge in harbors, follow fishing boats, or forage for schools of fish with other seabirds.
Grey gulls grow to a length of about 18 in and weigh 13 to 14 ounces. They communicate with a yelping "kyow" and a growled, rising "grrraaahh," along with low moans and shrill cries.', 40);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (111, 'Hadada ibis are large gray to partly brown birds with an iridescent greenish-purple sheen on their wings.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (112, 'Harbor seals are found north of the equator along the coasts of the Atlantic and 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (113, 'Harris''s hawks are extremely social birds and typically live and hunt in social groups. This lifestyle, unusual for raptors, has earned them the nickname "Wolves of the Sky."
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (61, 'Male hooded mergansers are named for the crest of feathers on the back of their heads, which can be expanded or contracted.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (63, 'Humboldt penguins live along the west coasts of Peru and Chile. They are named after the cold Humboldt Current that runs from the Antarctic to the equator along the west coast of South America.
They are one of 17 penguin species in the world, all of which live in the Southern hemisphere.', 46);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (64, 'Inca terns feed on anchovies, mote sculpins and silversides; they swoop down from the air to snatch the tiny fish from the top few inches of water. They rarely dive deeper.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (65, 'The Indian runner duck is nicknamed the bowling pin duck because it shares the same shape: upright and long, with a small head funneling into a thin neck and larger body.
Like most domestic ducks, the breed was developed from the mallard. Although the Indian runner duck lays a large number of eggs, it does not usually sit on them. Breeders sometimes place eggs under a broody duck to hatch them.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (66, 'Kinkajous are opportunistic frugivores, eating whatever fruit is abundant. Figs are a favorite. They may supplement their diet with insects, flowers and nectar depending on what is available.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (67, 'Lesser flamingos get their pink color from pigments in an algae called spirulina, which is their primary food.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (68, 'Lions are mostly crepuscular (active at dawn and dusk) and spend much of the day 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (69, 'Hissing cockroaches live in large colonies.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (70, 'Tarantulas'' name derives from the southern Italian town of Taranto. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (71, 'Naked mole rats rarely use their eyes, but they have excellent hearing and touch. 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (72, 'Nankins are friendly and calm.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (73, 'Goats are browsers, eating tips of woody shrubs and trees. They often improve a pasture by removing blackberry, weedy undergrowth and ivy (even poison ivy and poison oak) that other livestock won''t eat.
...
Color is one factor that makes these goats popular: black, gold, chocolate, Dalmatian-spotted, pint-patterned and other combinations are possible.', 56);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (74, 'River otters are quick and agile, swimming up to 7 miles an hour by paddling with their 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (75, 'The northern pintail is graceful and acrobatic in flight – and is nicknamed ''greyhound of the air'' for its rapid flight.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (76, 'Northern shovelers dip their beaks into shallow water and filter foods such as insects, plants and seeds.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (77, 'Rabbits are altricial (helpless, naked and blind when born). Hares are precocial (generally born with hair, able to see and move around).
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (78, 'Orangutans are active during the day and build tree nests each night out of leaves and branches, often as much as 120 feet above the ground. Their opposable thumbs and big toes combine with long arms and highly mobile shoulder and hip joints to give them easy, flexible movement through the trees.
Orangutans eat bark, leaves, flowers, insects and over 300 different species of fruit. Young orangutans learn from their mothers what food to eat and where and when to find it. Orangutans have large brains and are highly intelligent. They have been known to make hats out of leaves to keep themselves dry, borrow human boats to cross open water, and use spears to catch fish.', 61);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (79, 'Pacific Lamprey belong to a family of eel-like fish. They''re anadromous—they migrate from fresh water to the ocean and back, as salmon do. But they don''t have scales, and instead of bones, they have cartilage.
Pacific Lamprey begin life about the size of a small bead and grow into adult between 3 and 7 years later on their way to the ocean. Adults have two blue eyes and a third "eye"—a light spot on the top of their head—to sense light and dark, and they smell using a nasal pore on the tops of their heads. They breathe using 7 paired gill slits. They swim like eels, using two fins at the top of their bodies and one fin near their tails.', 62);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (80, 'The male has large sailfins on its back and long tail; the female has dorsal fringe (near the back and upper surface).
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (81, 'The life of a polar bear
...
Polar bears eat primarily ice seals. They prefer ringed seals, but they also eat bearded, harp, and hooded seals. When food is plentiful, they eat only the skin and blubber and leave the rest of the carcass for Arctic foxes and other animals. In this way, polar bears are able to concentrate on high-calorie fat when food is plentiful and pack on the pounds.', 64);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (82, 'Pygmy goats are friendly, resilient and intelligent. They make a good impression on zoo visitors who pet them.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (83, 'Pygoras are friendly, alert, curious and easy to handle. They have the docile nature of angora goats with the spunk and playfulness of pygmy goats.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (84, 'Cold headwaters, creeks, rivers, cool lakes, estuaries and oceans are habitats used by different populations of Oncorynchus mykiss. Those fish that spend their entire lives in freshwater are called rainbow trout.
...
Rainbow trout eat aquatic and terrestrial insects, mollusks, crustaceans, fish eggs, minnows and other small fish (including other trout).', 67);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (85, 'Red pandas are great climbers that spend most of their time in the trees, assisted by 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (86, 'The male red-crested pochard has a rounded orange head, a red bill and a black breast.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (87, 'Red-tailed hawks are opportunistic, preying on a broad variety of animals: insects, rats, mice, squirrels, reptiles and other birds. About 75 percent of their diet consists of rodents and other small mammals. This flexibility in diet contributes to their successful adaptation to many types of ecosystems.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (88, 'Ring-tailed lemurs are hard to miss. They''re named for their 2-feet-long tails, 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (89, 'The ringtail is named for its long, bushy tail with 14 to 16 black and white bands.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (90, 'A mountain goat''s wool coat is white, an adaptation that helps it hide from predators by blending in with its snowy environment. It sheds its coat, or pelage, each summer.
...
Goats may form large groups in the winter in protected areas; in summer, they disperse into small bands, climb to higher elevations and congregate at salt licks.', 73);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (91, 'Rodrigues flying foxes are actually fruit bats. They''re called "flying foxes" because 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (92, 'The sacred ibis forages during the day in groups of 2-20 birds and occasionally in flocks of 100-300.
...
The sacred ibis is considered an invasive species in Florida, France, Italy and Spain, where escaped or introduced birds have established breeding colonies. Outside of their native range, sacred ibis pose potential threats to native birds by preying on their eggs.', 75);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (94, 'The Southern ground hornbill resides in open woodlands, savanna, and lightly wooded grasslands.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (95, 'Gazelle are crepuscular (active at dusk and before dawn).
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (96, 'The straw-colored fruit bat is adaptable to many habitats and lives in lowland forests and savannas of sub-Saharan Africa, from Senegal in the west, South Africa to the south, and Ethiopia in the east. It is an herbivore, eating wild fruits and nectar.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (97, 'Turkey vultures are scavengers. Though they prefer well-rotted carrion, they prey on mice and other small mammals, grasshoppers, and fish; they may also eat fruit or vegetables such as pumpkins.
...
In unorganized flocks of hundreds of birds, vultures migrate thousands of miles north each spring from tropical areas, and each fall return south to nesting sites. During migration little or no food is consumed.', 79);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (98, 'Also known as the cone-head chameleon, this lizard is named for the sharkfin-like casque on its head, which channels dew and condensation into its mouth.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (99, 'As the name suggests, Western painted turtles are marked with bright colors of red, yellow and olive on their neck, head, tail, legs and lower shell. Like all turtles, they are ectotherms—their temperature depends on their environment.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (100, 'The white sturgeon is North America''s largest fish. The largest on record was caught in 1898 and weighed approximately 1,500 lbs.
...
Using their suction cup-like mouth, sturgeon eat mollusks and small invertebrate when they are young. As adults, they feed predominantly on fish.', 82);

INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (101, 'White-cheeked gibbons are built for life in the trees. They''re 18 to 25 inches tall 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (102, 'White-faced whistling ducks are named for their high-pitched whistling calls.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (103, 'Wood ducks are one of few waterfowl to commonly perch in trees.
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (104, 'Here in the Pacific Northwest, bald eagles often eat dead and dying fish, especially 
...
INSERT INTO animal.facts (fact_id, fact, animal_id)
VALUES (105, 'Redheads feed by diving for seeds, plants, aquatic insects and small fish.
...
Redheads are migratory – it is estimated that 80 percent of redheads spend the winter months in the Laguna Madre of Texas and Mexico.', 87);
